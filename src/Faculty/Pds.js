import { Add, CallReceivedOutlined, Edit } from '@mui/icons-material'
import { Box, Button, Card, Paper, TableContainer, TableHead, TableRow, TableCell, TableBody, Table, CardContent, Dialog, DialogActions, DialogContent, DialogTitle, Radio, RadioGroup, FormControl, FormControlLabel, Grid, IconButton, MenuItem, Select, TextField, Typography } from '@mui/material'
        ...
        <Card sx={{ padding: 5, display: 'flex' }}>
            ...
            <Box sx={{ marginTop: 1 }} component="form">
                <table className="tg">
                    ...
                    <tbody>
                        <tr>
                            <td className="tg-0pky" colspan="7">WARNING: Any misrepresentation made in the Personal Data Sheet and the Work Experience Sheet shall cause the filing of administrative/criminal case/s against the person concerned.</td>
                        </tr>
                        <tr>
                ...
                <Button variant="outlined" sx={{ marginTop: 5 }}>Print</Button>
            </Box>
